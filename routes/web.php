...
Route::prefix('surat-masuk')->name('surat-masuk.')->group(function () {
    ...
    Route::get('/', [SuratMasukController::class, 'create'])->name('index');
...
Route::prefix('laporan')->name('laporan.')->group(function () {
    ...
    Route::get('/surat-masuk/pdf', [LaporanController::class,'suratMasukPdf'])->name('surat-masuk.pdf');
    Route::get('/surat-masuk/excel', [LaporanController::class,'suratMasukExcel'])->name('surat-masuk.excel');

    Route::get('/naskah-keluar', [LaporanController::class,'naskahKeluar'])->name('naskah-keluar');
    Route::get('/naskah-keluar/cetak', [LaporanController::class,'naskahKeluarCetak'])->name('naskah-keluar.cetak');
    Route::get('/naskah-keluar/pdf', [LaporanController::class,'naskahKeluarPdf'])->name('naskah-keluar.pdf');
    Route::get('/naskah-keluar/excel', [LaporanController::class,'naskahKeluarExcel'])->name('naskah-keluar.excel');
...
Route::view('/unit-kerja', 'pages.master.unit-kerja')->name('unit-kerja.index');
